...
export class DateTimeLiteral extends ParsableToken implements ILiteralToken {
  ...
  constructor(character: TokenCharacter) {
    ...
    this.validators = [
      ...
      value => this.validateExactMultiple(value, [TokenValues.Dash, TokenValues.Slash], DateTimeLiteral.DashIndexes),
      value => this.validateExact(value, TokenValues.Colon, DateTimeLiteral.ColonIndexes),
      value => this.validateExactMultiple(value, [charT, TokenValues.Space], DateTimeLiteral.SeparatorIndexes)
    ];
  }
